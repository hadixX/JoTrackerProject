...
public class AbpSolution1Module : AbpModule
{
    ...
    private void ConfigureAutoApiControllers()
    {
        ...
        {
            options.ConventionalControllers.Create(typeof(AbpSolution1Module).Assembly);
        });
    }
    ...
    {
        context.Services.AddAutoMapperObjectMapper<AbpSolution1Module>();
        Configure<AbpAutoMapperOptions>(options =>
        {
             ...
             */
            options.AddMaps<AbpSolution1Module>(/* validate: true */);
        });
    }
    ...
    {
        context.Services.AddDataProtection().SetApplicationName("AbpSolution1");
    }
    ...
    private void ConfigureVirtualFiles(IWebHostEnvironment hostingEnvironment)
    {
        ...
        {
            options.FileSets.AddEmbedded<AbpSolution1Module>();
            if (hostingEnvironment.IsDevelopment())
            {
                /* Using physical files in development, so we don't need to recompile on changes */
                options.FileSets.ReplaceEmbeddedByPhysical<AbpSolution1Module>(hostingEnvironment.ContentRootPath);
            }
        });
    }
