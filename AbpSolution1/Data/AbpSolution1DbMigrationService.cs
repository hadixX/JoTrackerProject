...
public class AbpSolution1DbMigrationService : ITransientDependency
{
    ...
    private readonly AbpSolution1DbSchemaMigrator _dbSchemaMigrator;
    private readonly ITenantRepository _tenantRepository;
    private readonly ICurrentTenant _currentTenant;

    public AbpSolution1DbMigrationService(
        IDataSeeder dataSeeder,
        AbpSolution1DbSchemaMigrator dbSchemaMigrator,
    ...
    public async Task MigrateAsync()
    {
        ...
        if (AbpSolution1Module.IsMultiTenant)
        {
    ...
    private string GetEntityFrameworkCoreProjectFolderPath()
    {
        ...
        return Path.Combine(slnDirectoryPath, "AbpSolution1.Mvc");
    }
