...
public class AbpSolution1PermissionDefinitionProvider : PermissionDefinitionProvider
{
    public override void Define(IPermissionDefinitionContext context)
    {
        ...
        var carsPermission = myGroup.AddPermission(AbpSolution1Permissions.Cars.Default, L("Permission:Cars"));
        booksPermission.AddChild(AbpSolution1Permissions.Cars.Create, L("Permission:Cars.Create"));
        booksPermission.AddChild(AbpSolution1Permissions.Cars.Edit, L("Permission:Cars.Edit"));
        booksPermission.AddChild(AbpSolution1Permissions.Cars.Delete, L("Permission:Cars.Delete"));
